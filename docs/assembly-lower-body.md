...
2. Secure motors with 4 **M3 locking hex nuts**.
...
4. Orient motors 13 and 16 at ~90 degree angle on lower legs. Attach with 8 **silver servo horn M3 screws**.
